...
| 说明        | 值                                                        |
| ----------- | --------------------------------------------------------- |
| HTTP URL    | https://openapi.zhihu.com/openapi/hackathon\_story/detail |
| HTTP Method | GET                                                       |
...
| 参数名   | 类型  | 必填 | 说明                                        |
| -------- | ----- | ---- | ------------------------------------------- |
| work\_id | int64 | 是   | 内容库中的作品 ID，如 `1644038836790169600` |
...
| 字段名         | 类型            | 说明                                     |
| -------------- | --------------- | ---------------------------------------- |
| work\_id       | string          | 作品 ID                                  |
| chapter\_name  | string          | 章节名称                                 |
| author\_avatar | string          | 作者头像 URL                             |
| author\_name   | string          | 作者姓名                                 |
